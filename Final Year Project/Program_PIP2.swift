...
class Program_PIP2{
    ...
    //    }
    init(){
        self.intro = "this is PIP2!"
        self.name = "PIP2"
        self.sessionList = [PIP2.session_1, PIP2.session_2, PIP2.session_3, PIP2.session_4, PIP2.session_5]
    }
    
    struct PIP2 {
        
        
        static let nameKey = "PIP2"
        static let introKey = "PIP2_introduction"
        static let sessionKey = "PIP2_sessions"
