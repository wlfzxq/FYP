...
class Program_PIP1{
    ...
    //    }
    init(){
        self.intro = "this is pip1!"
        self.name = "pip1"
        self.sessionList = [PIP1.session_1, PIP1.session_2, PIP1.session_3, PIP1.session_4, PIP1.session_5]
    }
    
    struct PIP1 {
        
        
        static let nameKey = "pip1"
        static let introKey = "pip1_introduction"
        static let sessionKey = "pip1_sessions"
