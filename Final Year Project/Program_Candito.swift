...
class Program_Candito{
    ...
    //    }
    init(){
        self.intro = "this is Candito!"
        self.name = "Candito"
        self.sessionList = [Candito.session_1, Candito.session_2, Candito.session_3, Candito.session_4, Candito.session_5]
    }
    
    struct Candito {
        
        
        static let nameKey = "Candito"
        static let introKey = "Candito_introduction"
        static let sessionKey = "Candito_sessions"
